...
export default defineUserConfig({
  ...
  lang: 'zh-CN',
  title: 'Roor',
  description: 'Roor&#x27;s blog',

  head: [
    // 配置站点图标
    ['link', { rel: 'icon', type: 'image/png', href: '/Roor.svg' }],
  ],
  ...
  theme: plumeTheme({
    ...
    plugins: {
      ...
      //   // 强烈建议预设代码块高亮语言，插件默认加载所有语言会产生不必要的时间开销
        languages: ['shell', 'bash', 'typescript', 'javascript','python' ,'c++', 'vue', 'css', 'html', 'json', 'sql', 'yaml', 'java', 'xml'],
